...
@Designate(ocd = Task10.Config.class)
public class Task10 implements Runnable {
    ...
    public @interface Config {
        ...
        String scheduler_cron_expression() default "0 0/1 * 1/1 * ? *";
    ...
    private String pagePath = "/content/aem-guides-Project/us/en";
    ...
    private ResourceResolver getServiceResourceResolver() throws Exception {
        ...
        authInfo.put(ResourceResolverFactory.SUBSERVICE, "welcome");
