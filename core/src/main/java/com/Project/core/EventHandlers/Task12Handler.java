package com.Project.core.EventHandlers;
...
public class Task12Handler implements EventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(Task12Handler.class);

    @Reference
    private ResourceResolverFactory resourceResolverFactory;

    private static final String WORKFLOW_MODEL_PATH = "/var/workflow/models/Task13";
    ...
    private ResourceResolver getServiceResourceResolver() throws LoginException {
        return resourceResolverFactory.getServiceResourceResolver(
                Collections.singletonMap(ResourceResolverFactory.SUBSERVICE, "welcome"));
    }
}
